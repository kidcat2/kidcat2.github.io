...
Interest : Coumputer Graphics, VR, AR, Game Engine, HCI <br>
...
#### **소개**
`이미지 개선(Enhancement)`이란 색상 복원, 디테일 향상, 또는 특정 스타일 반영 등을 통해 이미지의 품질을 높이는 작업으로, 컴퓨터 비전에서 중요한 연구 주제 중 하나입니다. <br>
